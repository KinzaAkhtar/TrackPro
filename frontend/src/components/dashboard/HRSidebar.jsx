...
const HRSidebar = () => {
    return(
        ...
        <div className="bg-gradient-to-t from-red-700 via-orange-700 to-yellow-300 text-white h-[95vh]  fixed left-3 top-3 bottom-0 sapce-y-2 w-64 rounded-lg">
            ...
            <div className="mt-8">
                <NavLink to="/hr-dashboard" className={({isActive}) => `${isActive ? "bg-white bg-opacity-20" : " "} flex items-center space-x-4 bock py-2.5 px-4 hover:bg-yellow-600 rounded-lg} `}
                end
                >
                ...
                <NavLink to="hr-dashboard/attendance-and-leaves" className="flex items-center space-x-4 bock py-2.5 px-4 hover:bg-yellow-600 rounded-lg">
                    <FaCalendarCheck className="mr-2"/>
                    <span>Attendance and Leaves</span>
                </NavLink>
                <NavLink to="hr-dashboard/payroll" className="flex items-center space-x-4 bock py-2.5 px-4 hover:bg-yellow-600 rounded-lg">
                    <FaDollarSign className="mr-2"/>
                    <span>Payroll</span>
                </NavLink>
                <NavLink to="hr-dashboard/tasks" className="flex items-center space-x-4 bock py-2.5 px-4 hover:bg-yellow-600 rounded-lg">
                    <FaTasks className="mr-2"/>
                    <span>Tasks</span>
                </NavLink>
                <NavLink to="hr-dashboard/settings" className="flex items-center space-x-4 bock py-2.5 px-4 hover:bg-yellow-600 rounded-lg">
